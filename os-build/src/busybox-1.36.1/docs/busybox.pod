...
Currently available applets include:
	...
	ash, basename, bash, cat, chmod, chown, chroot, clear, cp, cpio,
	cut, date, dd, df, dirname, dmesg, du, echo, false, find, free,
	getty, grep, gunzip, gzip, head, hostname, id, init, kill, ln, ls,
	mkdir, mknod, mktemp, mount, mv, poweroff, ps, pwd, reboot, rm,
	rmdir, sh, sleep, sort, stat, switch_root, tail, tar, tee, test,
	touch, tr, true, umount, uname, uniq, uptime, vi, wc, whoami
